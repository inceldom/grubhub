--yes i am Boxking776, unless you are a developer, you shouldn't be here >:( go away
...
local uiParent = game:GetService("RunService"):IsStudio() and game:GetService("Players").LocalPlayer.PlayerGui or game:GetService('CoreGui');
    ...
    ----------------------------------------------------------- Setings
        library.Settings = {
            ...
            toggleImage = "rbxassetid://1202200114";
            rippleImage = "rbxassetid://2708891598";
            borderRainbow = false; ----------------------------------------------------------- CHANGE RAINBOW SETTINGS HERE
        };
    end
    ...
    function library:CreateWindow(name)
		...
		local function minimise()
            if minimised then
                for _,v in pairs(Window:GetChildren()) do if v.Visible ~= nil and v.Name ~= "Minimise" and v.Name ~= "WindowName" then v.Visible = true end end
            else
                for _,v in pairs(Window:GetChildren()) do if v.Visible ~= nil and v.Name ~= "Minimise" and v.Name ~= "WindowName" then v.Visible = false end end                
            end
        ...
        Minimise.Parent = Window
        Minimise.BackgroundColor3 = Color3.new(0.137255, 0.137255, 0.137255)
        Minimise.BorderColor3 = Color3.new(0.337255, 0.337255, 0.337255)
        Minimise.Position = UDim2.new(1, -35, 0, -35)
        Minimise.Size = UDim2.new(0, 35, 0, 35)
        Minimise.Font = Enum.Font.SourceSans
        Minimise.Text = "-"
        Minimise.TextColor3 = library.Settings.textColor
        Minimise.TextSize = 25
	Minimise.BorderSizePixel = 0
	Minimise.MouseButton1Click:Connect(function()
		    minimise()
		    wait(0.1)
if Minimise.Text == '-' then
    Minimise.Text = "+"
        ...
        function window:Resize()
            ...
            if not Container.Visible then Size = UDim2.new(0, 180, 0, 0); end
